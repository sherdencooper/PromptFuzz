...
if __name__ == "__main__":
    ...
    parser.add_argument('--phase', choices=['evaluate', 'focus', 'init'], default='focus', help='The phase of the fuzzing process')
    ...
    parser.add_argument("--retrieval_method", choices=['random', 'cluster', 'cosine_similarity'], default='cosine_similarity', help='The retrieval method')
    ...
    parser.add_argument("--dynamic_allocate", default=True, help='Dynamic allocate the energy')
